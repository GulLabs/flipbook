---
'@gullabs/flipbook-core': minor
'@gullabs/react-flipbook': minor
---

Add `turnProgress` event and React `onTurnProgress` for scrubber/progress UI during animated turns and drags (PLAN-3.1 Campaign C).
